...
function EnhancedTableHead(props) {
  const { onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort, selectable, headCells } =
    props;
...
export default function EnhancedTable(props) {
  ...
  const [filteredRows, setFilterRows] = React.useState([]);
    ...
    <Box sx={{ width: '100%' }}>
      ...
      >
        <FormControlLabel
          ...
          control={<Switch checked={isSelectable} onChange={handleChangeDense} />}
          label="Select"
        />
      </div>
      <Paper sx={{ width: '100%', mb: 2 }}>
        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={filteredRows.length > 0 ? filteredRows.length : props.rows.length}
        ...
        <TablePagination
          ...
          component="div"
          count={filteredRows.length > 0 ? filteredRows.length : props.rows.length}
