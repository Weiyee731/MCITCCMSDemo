    ...
    const CollapseLayout = (data, index) => {
        return (
            <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
                ...
                {data.OrderProductDetail !== undefined && JSON.parse(data.OrderProductDetail).map((x) => {
                    console.log("dsdsda,", x)
                })}
                {/* {console.log("dsdasdada", data.)} */}
                                    ...
                                    <div className="col-2">
                                        {
                                            ...
                                            <div className="col-5">
                                                <div >  </div>
                                                <div style={{ fontSize: "11px", fontWeight: "bold" }}>  Courier Service : {checkLogistic(data.logisticID)} </div>
                                                <div style={{ fontSize: "11px", fontWeight: "bold" }}>  Tracking Number :  {data.TrackingNumber}  </div>
                                            </div>
                                        }
                                    </div>
                                ...
                                <div className="col-3">
                                    ...
                                    <FormControl fullWidth size="small" variant="outlined">
                                        <Select
                                            ...
                                            onChange={(e) => {
                                                let newArr = OrderListing
                                                newArr[index].logisticID = e.target.value
                                                setOrderListing([...newArr]);
                                            }}
                                            className="select"
                                            required
                                                ...
                                                <div className="col">
                                                    ...
                                                    <FormControl fullWidth size="small" variant="outlined">
                                                        <OutlinedInput
                                                            ...
                                                            onChange={(e) => {
                                                                let newArr = OrderListing
                                                                newArr[index].trackingNumber = e.target.value
                                                                newArr[index].isTrackingNumberError = e.target.value === "" ? true : false
                                                                setOrderListing([...newArr]);
                                                            }}
                                                            required
                                                        />
                                        ...
                                        <div className="col">
                                            ...
                                            <FormControl fullWidth size="small" variant="outlined">
                                                <OutlinedInput
                                                    ...
                                                    onChange={(e) => {
                                                        let newArr = OrderListing
                                                        newArr[index].parcelQuantity = e.target.value
                                                        newArr[index].isParcelQuantityError = e.target.value <= 0 || e.target.value == "" ? false : true
                                                        setOrderListing([...newArr]);
                                                    }}
                                                    required
                                                />
